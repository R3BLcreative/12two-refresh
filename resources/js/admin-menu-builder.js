...
document.addEventListener('DOMContentLoaded', function () {
	...
	const destroyBtns = builder.querySelectorAll('button.remove-menu-item');
	const createBtns = builder.querySelectorAll('button.add-menu-item');
	const linkSelects = builder.querySelectorAll('.link-select select');

	// SORTABLE UI
	var sortableMenu = new Sortable(builder, {
		handle: '.handle',
		group: 'menu-builder',
		draggable: 'li',
		onSort: (e) => {
