...
@php $grid_temp = 'grid-cols-[24px_auto_150px_150px]'; @endphp

{{-- HEADER --}}
<div class="grid {{ $grid_temp }} gap-4 bg-surface-light-500 px-8 py-3 shadow-sm font-black border-t border-b border-gray-300 text-body-light-600 relative z-99">
...
<div class="overflow-auto overscroll-contain flex-auto">
	...
	@foreach ($users as $user)
		<div class="grid {{ $grid_temp }} items-center px-8 py-4 gap-4 border-b border-gray-200 odd:bg-gray-50 tranistion-all ease-in-out hover:bg-surface-light-500 group/row">
			{{-- ID --}}
			...
			{{-- NAME --}}
			<a href="{{ route('admin.users.edit', [$user]) }}" class="flex items-center gap-4">
