...
return [
    ...
    */
	...
	'custom' => [
		'slug' => [
			'unique' => 'That slug is already in use.',
		],
		'title' => [
			'unique' => 'That title is already being used.',
		],
		'roles' => [
			'required' => 'Please select at least one role to assign this permission to.',
		],
		'permissions' => [
			'required' => 'Please select at least one permission to assign to this role.',
		],
		'password' => [
